...
public class RpcPartitionTest {
    ...
    public void testCompare() {
        ...
        RpcPartition pd1 = new RpcPartition(
                DATABASE_1, TABLE_1, null, BE_1, tabletSet1, QUERY_PLAN_1, null, null);
        RpcPartition pd3 = new RpcPartition(
                DATABASE_2, TABLE_1, null, BE_1, tabletSet1, QUERY_PLAN_1, null, null);
        RpcPartition pd4 = new RpcPartition(
                DATABASE_1, TABLE_2, null, BE_1, tabletSet1, QUERY_PLAN_1, null, null);
        RpcPartition pd5 = new RpcPartition(
                DATABASE_1, TABLE_1, null, BE_2, tabletSet1, QUERY_PLAN_1, null, null);
        RpcPartition pd6 = new RpcPartition(
                DATABASE_1, TABLE_1, null, BE_1, tabletSet2, QUERY_PLAN_1, null, null);
        RpcPartition pd7 = new RpcPartition(
                DATABASE_1, TABLE_1, null, BE_1, tabletSet3, QUERY_PLAN_1, null, null);
        RpcPartition pd8 = new RpcPartition(
                DATABASE_1, TABLE_1, null, BE_1, tabletSet1, QUERY_PLAN_2, null, null);
